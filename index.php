...
// 4. NUOVO: Calcolo Salute Sistema (Cron & Disco)
$lastcron = get_config('tool_task', 'lastcronstart');
$cron_delay = time() - $lastcron;
$is_cron_ok = ($cron_delay < 300); // OK se < 5 minuti
...
// 5. Recupero Dati CACHED (Plugin dal JSON in MOODLEDATA)
                    ...
                    <div>
                        ...
                        <?php if ($core_update_msg): ?>
                            <span class="badge badge-danger p-2">
                                <i class="fa fa-arrow-circle-up"></i> Aggiornamento: <?php echo $core_update_msg; ?>
                            </span>
                        <?php else: ?>
                            <a href="<?php echo new moodle_url('/admin/index.php'); ?>" class="btn btn-sm btn-outline-secondary" target="_blank">
                                <i class="fa fa-check-circle"></i> Stato Sistema
                            </a>
                        <?php endif; ?>
                    </div>
        ...
        <div class="col-md-6">
            <div class="alert <?php echo $is_cron_ok ? 'alert-success' : 'alert-danger'; ?> d-flex justify-content-between align-items-center mb-0 shadow-sm" style="height: 100%;">
                <span>
                    ...
                    <?php if ($is_cron_ok): ?>
                        Attivo (ultimo giro <?php echo $cron_delay; ?>s fa)
                    <?php else: ?>
                        FERMO DA <?php echo floor($cron_delay / 60); ?> MINUTI!
                    <?php endif; ?>
                </span>
        ...
        <div class="col-md-6">
            <div class="alert <?php echo ($disk_usage_pct < 90) ? 'alert-info' : 'alert-danger'; ?> mb-0 shadow-sm">
                <div class="d-flex justify-content-between">
                    <span>
                        <i class="fa fa-hdd-o mr-2"></i>
                        <strong>Moodledata:</strong> <?php echo $disk_usage_pct; ?>% Usato
                    </span>
                    <small><?php echo $disk_free_gb; ?> GB Liberi</small>
                </div>
                <div class="progress mt-2" style="height: 6px;">
                    <div class="progress-bar bg-<?php echo ($disk_usage_pct < 90) ? 'white' : 'danger'; ?>" 
                         style="width: <?php echo $disk_usage_pct; ?>%; opacity: 0.8;"></div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card text-white bg-primary mb-3 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <?php else: ?>
                        ...
                        <p class="card-text"><small>Load Avg (Cluster/Host)</small></p>
                    <?php endif; ?>
                </div>
            </div>
        </div>
            ...
            <div class="card text-white bg-info mb-3 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <?php else: ?>
                        ...
                        <p class="card-text"><small>Dati non disponibili</small></p>
                    <?php endif; ?>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            ...
            <?php else: ?>
                <table class="table table-striped table-hover shadow-sm bg-white">
                    <thead>
                        <tr><th>Plugin</th><th>Versione</th><th>Stato</th></tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if (!empty($p->display)) {
                                    ...
                                    echo '<span class="text-muted" style="font-family:monospace;">' . $p->version . '</span>';
                                }
                                ?>
                            </td>
                            <td>
                                <?php if (!empty($p->update_available)): ?>
                                    <span class="badge badge-danger">
                                        <i class="fa fa-arrow-up"></i> Upd: <?php echo $p->update_available; ?>
                                    </span>
                                <?php else: ?>
                                    <span class="badge badge-success">
                                        <i class="fa fa-check"></i> Aggiornato
                                    </span>
                                <?php endif; ?>
                            </td>
                        </tr>
